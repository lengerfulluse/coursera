 ...
 * 
 */
@WebServiceClient(name = "HelloWebServiceService", targetNamespace = "http://javaee.tutorial.t.hengwei.me/", wsdlLocation = "http://localhost:8080/HelloWebService-war/HelloWebServiceService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWEBSERVICESERVICE_QNAME = new QName("http://javaee.tutorial.t.hengwei.me/", "HelloWebServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/HelloWebService-war/HelloWebServiceService?wsdl");
    ...
    public HelloWebService getHelloWebServicePort() {
        return super.getPort(new QName("http://javaee.tutorial.t.hengwei.me/", "HelloWebServicePort"), HelloWebService.class);
    }
    ...
    public HelloWebService getHelloWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://javaee.tutorial.t.hengwei.me/", "HelloWebServicePort"), HelloWebService.class, features);
    }
